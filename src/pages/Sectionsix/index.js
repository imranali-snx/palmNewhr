      ...
      <Row>
        <Col xs={24} sm={24} md={24} lg={8} xl={10} xxl={10} className="left-tag" align="middle" style={{paddingTop:"8%" }} >
          ...
          <div className="left-list" >
             <ul>
              <li><CheckCircleOutlined style={{color:"#219387"}} />  Ess profiles & Data</li>
              <li><CheckCircleOutlined style={{color:"#529571" }}/>  Document Management</li>
              <li><CheckCircleOutlined style={{color:"#81965c" }} />  Organization Charts</li>
              <li><CheckCircleOutlined style={{color:"#b39845" }}/>  Team Insights & Reports</li>
              <li><CheckCircleOutlined style={{color:"#e29a30" }}/>  Asset Management</li>
            </ul>
            
          </div>
          <button className="left-tag-btn">Learn More</button>
        </Col>
        <Col xs={24} sm={24} md={24} lg={16} xl={14} xxl={14} align="middle" style={{ marginTop:"-50px"}}>
