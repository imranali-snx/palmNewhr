          ...
          <div className="position-hero">
            <div className="leftmargin-hero">
              <p className="first-line">
                HRMS for Companies of all Sizes in <span className="saudi"> Saudi Arabia</span>
              </p>
              <h2 className="title-hero">Lorem Ipsum Dolor Sit Amet<span className="dot-color">.</span></h2>
